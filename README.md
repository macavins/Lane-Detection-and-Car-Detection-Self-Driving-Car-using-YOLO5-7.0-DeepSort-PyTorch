...
2. Make sure that you fulfill all the requirements: Python 3.8 or later with all [requirements.txt](https://github.com/macavins/Lane-Detection-and-Car-Detection-Self-Driving-Car-using-YOLO5-7.0-DeepSort-PyTorch/blob/main/requirements.txt) dependencies installed, including torch>=2.1.0. To install, run:
